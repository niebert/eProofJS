...
$vOut.="    vContent += \"<input type='button' class='bUseStep' step='\"+vNr+\"'  id='bUseStep\"+vNr+\"' value=' + ' onclick=\\\"appendStep(\"+vNr+\")\\\" style='visibility:hidden' />\"; //style='visibility:hidden'\n"
$vOut.="    vContent += setStepConnection(vNr,pCount);\n"
$vOut.="    vContent += \"<input type='button' class='bEdit' step='\"+vNr+\"'  id='bEdit\"+vNr+\"'  value=' EDIT ' onclick=\\\"toggleEdit(\"+vNr+\")\\\" />\";\n"
$vOut.="    vContent += setStepDefinition(vNr,pCount,pAllSteps,pList[k].id);\n"
$vOut.="    vContent += \"<input type='button' class='bDelete' step='\"+vNr+\"'  id='bDelete\"+vNr+\"' value=' X ' onclick=\\\"deleteProofStep(\"+vNr+\",\"+pCount+\")\\\" style='color:red'/>\";\n"
...
$vOut.="    vContent +=\"<OUTSTEP class='outSTEP' id='outSTEP\"+vNr+\"' style='display:none'>\";\n"
...
$vOut.="  var vName = \"outSTEPDISPLAY\"+pStep; \n"
$vOut.="  var vID = \"\";\n"
$vOut.="  var i = 0;\n"
$vOut.="  var vDisp = \"\";\n"
$vOut.="  for (var vID in pAllSteps) {\n"
$vOut.="    i++;\n"
$vOut.="    vContent += \"<OUTTEXT class='\"+vName+\"' id='\"+vName+\"-POS-\"+i+\"' \"+vDisp+\">(\"+i+\")</OUTTEXT>\";\n"
$vOut.="  };\n"
$vOut.="  vContent += vSpace+\"</td><td valign='center'  width='\"+vCellWidth+\"'>\";\n"
$vOut.="  vContent += \"<OUTTEXT class='\"+vName+\"' id='\"+vName+\"-CON-NA' \"+vDisp+\">\"+AP+ \"???\" + AP +\"</OUTTEXT>\";\n"
$vOut.="  vContent += \"<OUTTEXT class='\"+vName+\"' id='\"+vName+\"-CON-0' \"+vDisp+\">\"+AP+ \"???\" + AP +\"</OUTTEXT>\";\n"
$vOut.="  i = 0;\n"
$vOut.="  while (lower(i,vConnectionArray.length)) {\n"
$vOut.="    vContent += \"<OUTTEXT class='\"+vName+\"' id='\"+vName+\"-CON-\"+i+\"' \"+vDisp+\">\"+AP+vConnectionArray[i] + AP +\"</OUTTEXT>\";\n"
$vOut.="  i++;\n"
$vOut.="  }\n"
$vOut.="  vContent += vSpace+\"</td><td valign='center' align='left'>\";\n"
$vOut.="  for (var vID in pAllSteps) {\n"
$vOut.="      vContent += \"<OUTTEXT class='\"+vName+\"' id='\"+vName+\"-STEP-\"+vID+\"' stepid='\"+vID+\"' \"+vDisp+\">\"+getStepDef4ID(vID) +\"</OUTTEXT>\";\n"
$vOut.="  };\n"
...
$vOut.="  if (pStep) {\n"
$vOut.="    var vOutName = \"outSTEPDISPLAY\"+pStep;\n"
$vOut.="    var vViewList = document.getElementsByClassName(vOutName);\n"
$vOut.="    var k=0;\n"
$vOut.="  while (lower(k,vViewList.length)) if (vViewList[k].style) {\n"
$vOut.="      vViewList[k].style.display = \"none\";\n"
...
$vOut.="  var vName = \"outSTEPDISPLAY\"+pStep+\"-STEP-\"+vID;\n"
...
$vOut.="  }\n"
$vOut.="}\n"
$vOut.="function X_updateStep(pStep) {\n"
$vOut.="  var vOutString = \"\"\n"
$vOut.="  var vPos = document.getElementById(\"sPOSITION\"+pStep);\n"
$vOut.="  if (vPos) {\n"
...
$vOut.="    };\n"
$vOut.="    if (vConnection != \" \") {\n"
$vOut.="      vOutString +=  \" \"+AP+ vConnection + AP + \"  \" +vSpace;\n"
$vOut.="    };\n"
$vOut.="    var vStepID = document.getElementById(\"sSTEP\"+pStep);\n"
$vOut.="    var vStepDef_Node = document.getElementById(\"inSTEPDEF\"+pStep);\n"
...
$vOut.="  } else {\n"
$vOut.="    alert(\"updateStep(\"+pStep+\")-Call and sPOSITION\"+pStep+\" was undefined\");\n"
$vOut.="  }\n"
$vOut.="}\n"
...
$vOut.="  vCountStepNode.value = vCountProof;\n"
$vOut.="}\n"
...
$vOut.="    pValue = pValue.replace(/__AE__/g,\"Ä\");\n"
$vOut.="    pValue = pValue.replace(/__OE__/g,\"�-\");\n"
